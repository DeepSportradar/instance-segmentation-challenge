...
data_root = '/home/ucl/elen/mistasse/seg_challenge/deepsport_dataset/'
data = dict(
    samples_per_gpu=8,
    workers_per_gpu=4,
    train=dict(
...
#         classes=classes,
#         type=dataset_type,
#         ann_file=os.path.join(_dir, 'gen-annotations.json'),
#         img_prefix=os.path.join(_dir, 'deepsport_dataset/data'),
#         pipeline=train_pipeline),
#     val=dict(
#         classes=classes,
#         type=dataset_type,
